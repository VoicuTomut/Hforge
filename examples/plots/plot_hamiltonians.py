...
from hforge.utils.model_load import load_model_from_directory
...
def main():
    ...
    directory = "example_results/supercell_usetapprox_2mp_sharing_mse_mean_costfn"
    ...
    results_directory = directory + "/" + "h_plots"
    ...
    with torch.no_grad():
        ...
        for i, sample_graph in enumerate(dataset):
            ...
            print("Generated plots ", i+1)

            if i >= max_i:
                print(f"Generated {max_i+1} plots. Stopping.")
                break
