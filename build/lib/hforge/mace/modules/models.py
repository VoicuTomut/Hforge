...
from hforge.mace.data import AtomicData
from hforge.mace.modules.radial import ZBLBasis
from hforge.mace.tools.scatter import scatter_sum
...
class MACE(torch.nn.Module):
    def __init__(
        ...
        print(" mcheck node_feats_irreps=", node_feats_irreps)
        print("mcheck node_attr_irreps=", node_attr_irreps)
        ...
        print("mace -- ssh_irreps", sh_irreps)
    ...
    def forward(
        ...
        # Embeddings
        print("node atr sapes :", data["node_attrs"].shape)
