...
from hforge.matrix_extraction_heads import MatrixExtractionHeadNodesConvolutional
...
class NodeExtractionUniversalApproximator2(nn.Module):
    def __init__(self, config_routine, device='cpu'):
        super(NodeExtractionUniversalApproximator2, self).__init__()
        ...
        for atom in self.atom_types:
            ...
            self.extraction_heads[str(atom)] = MatrixExtractionHeadNodesConvolutional(
